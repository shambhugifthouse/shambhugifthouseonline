...
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'shambhugifthouse@gmail.com')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', '')
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'Shambhu Gift House <shambhugifthouse@gmail.com>')
